...
/**
 * TRolePriId entity. @author MyEclipse Persistence Tools
 */

public class TRolePriId implements java.io.Serializable {
	...
	/** full constructor */
	public TRolePriId(TRole TRole, TPrivilege TPrivilege) {
		this.TRole = TRole;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TRolePriId))
			return false;
		TRolePriId castOther = (TRolePriId) other;
